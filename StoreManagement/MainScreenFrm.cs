...
namespace StoreManagement
{
    public partial class MainScreenFrm : Form
    {
        ...
        private void OrderHistoryPB_Paint(object sender, PaintEventArgs e)
        {

        }

        private void InventoryPB_Paint(object sender, PaintEventArgs e)
        {

        }

        private void InventoryPB_Click(object sender, EventArgs e)
        {
            MessageBox.Show("inventry clicked");
        }
    }
}
